...
SWIFT_CLASS("_TtC10EdgeEngine16EdgeEngineClient")
@interface EdgeEngineClient : NSObject
...
@interface EdgeEngineClient (SWIFT_EXTENSION(EdgeEngine))
@end
...
///
SWIFT_CLASS_NAMED("StartupParameters")
@interface EdgeEngineClientStartupParameters : NSObject <NSCoding>
